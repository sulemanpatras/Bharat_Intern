...
function initialize() {
    return new Promise((resolve, reject) => {
        ...
        let db = mongoose.createConnection("mongodb+srv://pro:LcCOqldGBQOdJU15@cluster0.gqwpn6y.mongodb.net/project2?retryWrites=true&w=majority&appName=AtlasApp", {useNewUrlParser: true, useUnifiedTopology: true});
        // Checking for errors
        db.on('error', (err)=>{
            reject(err);
        });
